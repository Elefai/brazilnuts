    ...
    <Card className="voice-card">
      <CardContent>
        ...
        {turn ? (
          ...
          <p className="voice-hint">O reconhecimento de voz pode enviar áudio ao serviço do navegador. Prefira digitar se não quiser usar o microfone. As respostas são demonstrativas, baseadas em regras.</p>
        )}
